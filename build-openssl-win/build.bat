...
::    Revision: $Id: build-openssl-1.0.1r.bat 4832 2016-02-15 15:03:07Z stathis $
::
...
SET PROJECT_VERSION=1.0.1s

:: SET PROJECT_SRC_DIR=D:\opensource\!BUILD_PROJECT!-!PROJECT_VERSION!
SET PROJECT_SRC_DIR=C:\OpenSSLBuild\!BUILD_PROJECT!-!PROJECT_VERSION!

SET PROJECT_INSTALL_DIR=C:\OpenSSLBuild\!BUILD_PROJECT!-dist-!PROJECT_VERSION!-vs!VS_VERSION!
...
SET COMMON_OPTIONS=enable-static-engine no-ssl2 no-ssl3
SET MODE=VC-WIN
